...
class HorariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post horarios_url, params: { horario: { data: @horario.data, fim: @horario.fim, inicio: @horario.inicio } }
    end
  ...
  test "should update horario" do
    patch horario_url(@horario), params: { horario: { data: @horario.data, fim: @horario.fim, inicio: @horario.inicio } }
